...
class ThermoType(Enum):
	'''
	This enum contains the available thermodynamic types for Navier-Stokes.
	see src/physics/navierstokes/tools.py for more information
	'''
	CaloricallyPerfectGas = auto()
		# Constant specific heat
	Cantera = auto()
		# Interface to external Cantera library
	Mutationpp = auto()
	    # Interface to external Mutation++ library
	NotNeeded = auto()
		# No thermodynamic properties required for physics class
