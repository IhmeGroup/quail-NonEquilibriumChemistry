...
from quail.physics.zerodimensional.functions import FcnType as zerod_fcn_type
from quail.physics.zerodimensional.functions import SourceType as zerod_source_type
